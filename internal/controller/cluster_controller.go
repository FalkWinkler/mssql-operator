...
//+kubebuilder:rbac:groups=mssql.f-wi.com,resources=clusters,verbs=get;list;watch;create;update;patch;delete
//+kubebuilder:rbac:groups=mssql.f-wi.com,resources=clusters/status,verbs=get;update;patch
//+kubebuilder:rbac:groups=mssql.f-wi.com,resources=clusters/finalizers,verbs=update
